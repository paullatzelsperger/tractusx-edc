...
![Version: 9.3.4](https://img.shields.io/badge/Version-9.3.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 9.3.4](https://img.shields.io/badge/AppVersion-9.3.4-informational?style=flat-square)
...
helm install my-release tractusx-edc/tractusx-connector-memory --version 9.3.4
```
